...
PROJECTDIR_MESSUI := $(BUILDDIR)/projects/messui/$(FULLTARGET)
...
.PHONY: vs2017_ARM
vs2017_ARM: generate
	$(SILENT) $(GENIE) $(PARAMS) $(TARGET_PARAMS)  --NO_OPENGL=1 vs2017
ifdef MSBUILD
	$(SILENT) msbuild.exe $(PROJECTDIR_MESSUI)/vs2017/$(PROJECT_NAME).sln $(MSBUILD_PARAMS) 
endif
